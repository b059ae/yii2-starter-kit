                    ...
                    'items'=>[
                        ...
                        [
                            ...
                            'items'=>[
                                ...
                                ['label'=>Yii::t('backend', 'Menu Widgets'), 'url'=>['/menu'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Carousel Widgets'), 'url'=>['/widget-carousel/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>'---'],
                                ['label'=>Yii::t('backend', 'Menu Widgets'), 'url'=>['/menu/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                            ]
                        ],
                        [
